...
?>
  ...
  function updateBackgroundPosition(element, frame) {
    ...
    <main id="main" class="container-fluid">
        ...
        <div class="download-notes text-center">
            <h1 class="features-title"><?php echo _('Release notes'); ?></h1>
        </div>
        ...
        <section class="row section d-flex align-items-center justify-content-around rounded">
          ...
          <div class="col-lg-7 text-light text-left px-md-4 rounded text-backround">
              <ul class="d-block whitelinks releases mt-3">
                <li><a href="<?php echo _('https://wiki.freecad.org/Release_notes_1.1" title="Release notes 1.1'); ?>"><?php echo _('Release 1.1 - March 2026'); ?></a> (<?php echo _('current stable release'); ?>)</li>
                <li><a href="<?php echo _('https://wiki.freecad.org/Release_notes_1.0" title="Release notes 1.0'); ?>"><?php echo _('Release 1.0 - November 2024'); ?></a></li>
